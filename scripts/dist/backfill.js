...
var require_service_account = __commonJS({
  "scripts/service-account.json"(exports2, module2) {
    module2.exports = {
      type: "service_account",
      project_id: "reality-auditor",
      private_key_id: "0f07e2d05505c880c8e3ceb212d3a3e53af4d5c9",
      private_key: "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
      client_email: "firebase-adminsdk-fbsvc@reality-auditor.iam.gserviceaccount.com",
      client_id: "105832623632743335858",
      auth_uri: "https://accounts.google.com/o/oauth2/auth",
      token_uri: "https://oauth2.googleapis.com/token",
      auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
      client_x509_cert_url: "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40reality-auditor.iam.gserviceaccount.com",
...
// scripts/backfill-subscriptions.ts
var serviceAccount = require_service_account();
...
async function updateSubscriptionStatus(userId, data, dryRun) {
  console.log(`\u{1F504} ${dryRun ? "[DRY RUN] " : ""}Updating subscription for user ${userId}:`, data);
  if (dryRun) return;
...
async function backfillSubscriptions(dryRun = true) {
  console.log(`\u{1F680} Starting subscription backfill ${dryRun ? "(DRY RUN)" : ""}`);
  try {
    ...
    for (const subscription of subscriptions.data) {
      ...
      console.log(`\u{1F4E7} Looking up user by email: ${customerEmail}`);
      const usersSnapshot = await adminDb.collection("users").where("email", "==", customerEmail).limit(1).get();
      let userId;
      if (usersSnapshot.empty) {
        console.log(`\u{1F4DD} Creating new user for ${customerEmail}`);
...
if (execute) {
  ...
  console.log("\u{1F50D} Running backfill in DRY RUN mode");
